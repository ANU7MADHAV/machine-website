...
const EnquiryForm = () => {
  return (
    <main className="h-100% mt-[220px] flex justify-center lg:mt-0 lg:h-[400px] lg:flex-row">
        ...
        <div className="flex flex-col items-center justify-center bg-[#F1EABA] px-4">
          ...
          <div className="flex flex-col gap-y-6 rounded-md border border-gray-800 p-6">
            <input
              ...
              className="rounded-md border border-gray-800 bg-[#F1EABA] px-2 py-1 text-xs placeholder-gray-500"
            />
            <input
              type="text"
            ...
            />
            <input
              className="cursor-pointer rounded-md bg-[#FFC048] text-center"
              value="Submit"
            />
          </div>
        </div>
